...
export const changeAccountEmailReq = (newEmail: string, keepOldEmail: boolean, password: string) => authApiInstance.post<User>('/v1/user/change-account-email', { newEmail, keepOldEmail, password });
