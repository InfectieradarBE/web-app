              ...
              {isAuth?
                <div className="dropdown nav-tabs">
                  <button
                    ...
                    aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-person-circle pe-1" viewBox="0 0 20 20">
                  ...
                  <div className = "dropdown-menu dropdown-menu-end ">
                    <button className="dropdown-item text-center" type = "button" >Settings
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-gear-fill ps-1 " viewBox="0 0 20 20">
                    ...
                    <button className="dropdown-item text-center" type = "button" onClick={() => setIsAuth(false)}>Logout
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-box-arrow-in-right ps-1 " viewBox="0 0 20 20">
              ...
              :
                ...
                <div className="row">
                  <ul className="nav nav-tabs justify-content-end  ">
                    <li className="nav item">
                      <button className="nav-link btn" onClick={() => setIsAuth(true)} >Login</button>
                    </li>
                    <li className="nav item">
                      <button className="nav-link btn "  >Signup</button>
                    </li>
                  </ul>
                </div>
